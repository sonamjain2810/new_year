...
import 'package:my_app/StickerDetailPage.dart';
...
class _StickerListState extends State<StickerList> {
  ...
  var data = Stickers.stickers_path;
            ...
            ? GridView.builder(
                ...
                itemBuilder: (context, index) {
                  return GestureDetector(
                      ...
                      onTap: () {
                        print("Click on Sticker Grid item $index");
                        Navigator.push(
                            context,
                            new MaterialPageRoute(
                                builder: (context) =>
                                    StickerDetailPage(index)));

                        facebookAppEvents.logEvent(
                          name: "Sticker List",
                          parameters: {
                            'clicked_on_sticker_index': '$index',
                          },
                        );
                      });
                },

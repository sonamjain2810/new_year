...
class StickerDetailPage extends StatefulWidget {
  int? index;
  StickerDetailPage(this.index);
  @override
  _StickerDetailPageState createState() => _StickerDetailPageState(index!);
}

class _StickerDetailPageState extends State<StickerDetailPage> {
  int index;

  _StickerDetailPageState(this.index);
                ...
                child: Card(
                  child: Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          CachedNetworkImage(
                            imageUrl: Stickers.stickers_path[index],
                              ...
                              children: <Widget>[
                                Visibility(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          "We are downloading your sticker to share.. \nBe Paitence Thanks!!",
  ...
  Future<void> shareJPGImageFromUrl(BuildContext context, int index) async {
    try {
      facebookAppEvents.logEvent(
        name: "Sticker Share",
        parameters: {
          'jpg_image_url': '$Stickers.stickers_path[index]',
        },
      );

      var request =
          await HttpClient().getUrl(Uri.parse(Stickers.stickers_path[index]));
  ...
  void onImageDowloadButtonPressed() async {
    var response = await http.get(Stickers.stickers_path[index] as Uri);

...
class WallpaperDetailPage extends StatefulWidget {
  int? index;
  WallpaperDetailPage(this.index);
  @override
  _WallpaperDetailPageState createState() => _WallpaperDetailPageState(index!);
}

class _WallpaperDetailPageState extends State<WallpaperDetailPage> {
  int index;

  _WallpaperDetailPageState(this.index);
                ...
                child: Card(
                  child: Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          CachedNetworkImage(
                            imageUrl: Wallpapers.wallpapers_path[index],
                              ...
                              children: <Widget>[
                                Visibility(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          "We are downloading your wallpaper to share.. \nBe Paitence Thanks!!",
  ...
  Future<void> shareJPGImageFromUrl(BuildContext context, int index) async {
    try {
      facebookAppEvents.logEvent(
        name: "Wallpaper Share",
        parameters: {
          'jpg_image_url': '$Wallpapers.wallpapers_path[index]',
        },
      );

      var request = await HttpClient()
          .getUrl(Uri.parse(Wallpapers.wallpapers_path[index]));
  ...
  void onImageDowloadButtonPressed() async {
    var response = await http.get(Wallpapers.wallpapers_path[index] as Uri);

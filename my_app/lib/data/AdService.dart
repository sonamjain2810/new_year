...
import 'package:my_app/StickerList.dart';
import 'package:my_app/WallpaperList.dart';
import '../AboutUs.dart';
...
class AdService {
  ...
  static void goTo(BuildContext? context, String interstitialTag) {
    switch (interstitialTag) {
      ...
      case "wallpaper":
        Navigator.of(context!).push(MaterialPageRoute(
            builder: (BuildContext context) => WallpaperList()));
        break;

      case "sticker":
        Navigator.of(context!).push(MaterialPageRoute(
            builder: (BuildContext context) => StickerList()));
        break;
